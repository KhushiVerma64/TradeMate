        ...
        <div className='container'>
            ...
            <div className='row p-5 mt-5 text-center'>
                <div className='col-4 p-5'>
                   ...
                   <p className='text-muted fs-5'>All equity delivery investments (NSE, BSE), are absolutely 
                    free — ₹ 0 brokerage.</p>
                </div>
                ...
                <div className='col-4 p-5'>
                   ...
                   <p className='text-muted fs-5'>Flat ₹ 20 or 0.03% (whichever is lower) per executed order on intraday 
